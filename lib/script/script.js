...
Script.prototype.isPublicKeyHashOut = function () {
  const isStandardP2pkh = !!(this.chunks.length === 5 &&
  ...
  // TODO perhaps don't check length because why not allow OP_RETURN payloads too
  const isUp2pkh = !!(this.chunks.length === 8 &&
    this.chunks[0].buf &&
    this.chunks[1].buf &&
    this.chunks[2].opcodenum === Opcode.OP_2DROP &&
    this.chunks[3].opcodenum === Opcode.OP_DUP &&
    this.chunks[4].opcodenum === Opcode.OP_HASH160 &&
    this.chunks[5].buf &&
    this.chunks[5].buf.length === 20 &&
    this.chunks[6].opcodenum === Opcode.OP_EQUALVERIFY &&
    this.chunks[7].opcodenum === Opcode.OP_CHECKSIG)

  return isStandardP2pkh || isUp2pkh;
}
...
Script.prototype.isPublicKeyOut = function () {
  ...
  if (this.chunks.length === 5) {
    if (
      this.chunks[3].buf &&
      this.chunks[3].buf.length &&
      this.chunks[4].opcodenum === Opcode.OP_CHECKSIG) {
      var pubkeyBuf = this.chunks[3].buf
      var version = pubkeyBuf[0]
      var isVersion = false
      if ((version === 0x04 ||
        version === 0x06 ||
